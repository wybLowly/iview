...
<template>
    <div>
        ...
        <Tree :data="data1" multiple title-width="20px"></Tree>

        <Dropdown trigger="click" style="display: block">
            <i-input readonly :placeholder="placeholder" v-model="deoptreeText"></i-input>
